...
###########
    ...
    st.write(res_vis)
    if (st.session_state.scelta_team == 'chiav_dr3') & (st.session_state.scelta_season == '23_24'):
    ...
    - 01/12/23: Arcore 53 - 63 Chiavenna (W)
    ...
    if (st.session_state.scelta_team == 'chiav_u15') & (st.session_state.scelta_season == '23_24'):
